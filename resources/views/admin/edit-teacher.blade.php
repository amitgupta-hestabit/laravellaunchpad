    ...
    <div class="row justify-content-center">
        ...
        @endif
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('admin.update-teacher',['userId' => $user->id])}}" enctype="multipart/form-data">
                        @csrf
                        @method('patch')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select disabled onchange="setMoreFields(this)" class="form-control @error('user_type') is-invalid @enderror" name="user_type" autocomplete="user_type">
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="experience" disabled type="number" class="form-control" name="experience" value="{{ $user->experience }}"  autocomplete="experience">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="expertise_in_subjects" class="col-md-4 col-form-label text-md-right">{{ __('Expertise In subjects') }}</label>
                                <div class="col-md-6">
                                    @php $subjects  = \App\Models\Subject::all();  $allSubjects = $user->expertiseInSubjects->pluck('id')->toArray(); @endphp
                                    <select multiple disabled class="form-control" id="expertise_in_subjects" name="expertise_in_subjects[]">
